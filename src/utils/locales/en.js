export default {
  auth: {
    ...
    newuser: {
      ...
      City: 'City',
      Landmark: 'Landmark',
      Street: 'Street/ Colony/Locality Name',
      Permanentaddress: 'Permanent House Flat/block no',
      ...
      Alreadyenroled: 'Already enrolled into loyalty scheme ?',
      Anualbusiness: 'Annual business Potenital',
      Selfie: 'Selfiee',

      AadharCardFront: 'Aadhar Card* (front)',
      AadharCardBack: 'Aadhar Card * (Back)',
      PanCardFront: 'Pan Card(Front)',
      IdProof: "Id Proof *(front)",
      ...
      NomineeeDob: 'Select Date of Birth',
    },
    forgot: {
  ...
  dashboard: {
    info: {
      vguardInfo: 'V-Guard Info',
      downloads: 'Downloads',
      catalogue: 'V-Guard Product Catalogue'
    },
    schemes: {
